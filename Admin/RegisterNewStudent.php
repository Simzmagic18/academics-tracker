...
if($link === false)
{
	...
	$sql1 = "INSERT INTO student (student_first_name, student_middle_name, student_last_name, date_of_birth, ethnicity, gender, password, user_type) VALUES ('$_POST[first_name]','$_POST[middle_name]','$_POST[last_name]','$_POST[date_of_birth]','$_POST[ethnicity]','$_POST[gender]','$_POST[password]','$_POST[user_type]')";
