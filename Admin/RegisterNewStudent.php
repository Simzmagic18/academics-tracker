...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$sql = "INSERT INTO student (student_first_name,student_middle_name,student_last_name,date_of_birth,ethnicity,gender,user_type, school_code, password) values('$name', '$mname','$lname','$dob','$race','$gen','$type', '$scode','$password')";
	$result = mysqli_query($conn, $sql);

 if(mysqli_query($conn, $sql)) {

	header("Location: successfulRecord.html");//  echo "Records Inserted Successfully.";
