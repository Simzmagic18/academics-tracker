...
<div align="center">
	...
	<form method = "post" action = "AddNewDepartment.php" name = "subject_form" enctype="multipart/form-data">
		<button class="button" onclick="AddNewDepartment.php"> Add Department </button>
		<button class="button" formaction = "ViewDepartments.php"> View Departments </button>
	</form>
