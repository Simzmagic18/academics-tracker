...
$query2 = $link->query("SELECT * FROM contacts WHERE student_id=$id");
...
<div class="super_container">
	...
	<div class="home">
        ...
        <form action="UpdateStudentProfile.php" name = "student_form" method="post" enctype="multipart/form-data" onsubmit = "return validateAllFields(this)">
            ...
            <label for="student_id"><b>Create User ID <abbr class="req" title="required">*</abbr>:</b></label> <span id="error-adid" span style = "float: right"></span><br>
