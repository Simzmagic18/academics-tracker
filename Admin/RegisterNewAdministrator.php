...
if($link === false)
{
	...
	$sql1 = "INSERT INTO administrator (admin_first_name, admin_middle_name, admin_last_name, date_of_birth, ethnicity, gender, id, school_code, password, user_type) VALUES ('$_POST[admin_first_name]','$_POST[admin_middle_name]','$_POST[admin_last_name]','$_POST[date_of_birth]','$_POST[ethnicity]','$_POST[gender]','$_POST[id]','$_POST[school_code]','$_POST[password]','$_POST[user_type]')";
