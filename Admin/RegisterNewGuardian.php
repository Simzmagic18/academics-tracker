...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$name = mysqli_real_escape_string($conn, $_POST['guardian_first_name']);
	$mname = mysqli_real_escape_string($conn, $_POST['guardian_middle_name']);
    $lname = mysqli_real_escape_string($conn, $_POST['guardian_last_name']);
...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" onsubmit = "return validateAllFields(this)>
            ...
            <input type="text" name="guardian_first_name" id ="guardian_first_name" onblur ="validateFirstName(guardian_first_name)"  maxlength = "20" required /><br>
            ...
            <input type="text" name="guardian_middle_name" id = "guardian_middle_name"  onblur ="validateMiddleName(guardian_middle_name)" maxlength = "20" ><br>
            ...
            <input type="text" name="guardian_last_name" id = "guardian_last_name" onblur ="validateLastName(guardian_last_name)" maxlength = "20" required><br>
...
<input type="submit" name="submit" value="Create"><br/>
   ...
   <button class="button" onclick="goBack()"> Back </button>
	...
	{
 		var alpha = /^[A-Za-z '-]+$/; //contains alphabetic characters, aostrophes and hyphens (accepted characters).
	...
	function validatestudentID(student_id) //allows numerical characters only and length should be 8
	{
		...
		else
		{
			...
			document.getElementById("student_id").style.display = "inline";
			document.getElementById('error-adid').innerHTML = "Incorrect Input. Please use numerical values only. And please check if the length of ID is 6.";
			return false;
		}
