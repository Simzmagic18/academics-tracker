...
$sql1 = "INSERT INTO teacher (teacher_first_name, teacher_middle_name, teacher_last_name, date_of_birth, ethnicity, gender, password, user_type) VALUES ('$_POST[teacher_first_name]','$_POST[teacher_middle_name]','$_POST[teacher_last_name]','$_POST[date_of_birth]','$_POST[ethnicity]','$_POST[gender]','$_POST[password]','$_POST[user_type]')";
