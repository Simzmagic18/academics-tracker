...
<?php
	...
	{	
		$submit = $_POST['submit'];	
			...
			$query = "SELECT * FROM guardian WHERE guardian_id='submit'";	//selects from guardian table
			$query2 = "SELECT * FROM contacts WHERE guardian_id='submit'"; //selects from contacts table
