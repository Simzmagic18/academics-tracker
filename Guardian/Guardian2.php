...
rowbtn{
  ...
  marin-right:-20px;
     ...
     <?php
                    ...
                    $sql =   " SELECT * FROM `student` WHERE guardian_id = '{$_SESSION['user']}' ";
                    
                    //$sql = "SELECT * FROM student WHERE guardian_ID=''";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<td>";
               ...
               $fname1 = $row['student_first_name'];
               
                
                echo "<span>    <a href='Guardian1.php?fname1=".$fname1."'><button>".$fname1."</button></a></span>";
